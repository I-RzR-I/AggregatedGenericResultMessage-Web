...
//  Last Modified On : 2026-04-22 21:50
// ***********************************************************************
...
namespace TestWebApi.ProblemDetails
{
    public sealed class BrandedProblemDetailsResultFactory : DefaultProblemDetailsResultFactory
    {
        ...
        {
            return $"https://errors.testwebapi.local/{(int)context.StatusCode}";
        }
            ...
            ResultProblemDetailsContext context)
        {
            ...
            problem.Extensions["service"] = "TestWebApi";
        }
    }
}