...
set applicationName=AggregatedGenericResultMessage.Web
...
set packResultPath=$('..\nuget\')
set packProjectsPath=$('..\src\AggregatedGenericResultMessage.Web\AggregatedGenericResultMessage.Web.csproj')
set testProjectsPath=
